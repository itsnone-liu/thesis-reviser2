...
AGG = {
    ...
    "合同法":       (55, ["股权转让", "企业借贷", "海上货物运输合同", "买卖合同", "借款合同", "确认合同无效", "居间合同", "赠与合同", "租赁合同", "担保", "保证", "定金", "违约金", "电信服务合同", "技术合同", "民间借贷", "债权转让", "房屋买卖", "商品房预售", "所有权确认", "委托贷款", "存款支付", "代位权", "债权纠纷"]),
    "侵权责任":     (50, ["机动车交通事故", "船舶碰撞", "航空旅客运输", "交通运输", "产品责任", "网络侵权", "银行卡纠纷", "网络盗刷", "安全保障义务", "医疗损害", "生命权", "人身权", "健康权", "身体权", "财产损害", "排除妨害", "相邻关系", "相邻通行", "交通事故", "船舶触碰", "饲养动物", "环境污染", "生态环境", "生态环境损害赔偿", "海上污染", "污染损害", "名誉权", "荣誉权", "故意伤害", "人格权", "销售者责任"]),
    "劳动法":       (40, ["劳动合同", "竞业限制", "劳动关系认定", "新就业形态", "工伤", "劳务派遣", "拖欠劳动报酬", "追索劳动报酬", "平等就业权", "就业歧视"]),
    "公司商事":     (40, ["公司法", "公司解散", "公司决议", "股东", "盈余分配", "合伙", "增资", "破产", "保险", "票据", "海事", "市场支配地位", "垄断"]),
    ...
    "涉外与其他":   (20, ["涉外", "国际商事", "仲裁", "海难救助", "外国法院民事判决", "信用证", "其他"]),
}
TARGET_TOTAL = 400
