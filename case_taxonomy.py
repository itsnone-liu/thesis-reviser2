...
AGG = {
    ...
    "合同法":       (55, ["股权转让", "企业借贷", "买卖合同", "借款合同", "确认合同无效", "居间合同", "赠与合同", "租赁合同", "担保", "保证", "定金", "违约金"]),
    "侵权责任":     (50, ["机动车交通事故", "船舶碰撞", "航空旅客运输", "交通运输", "产品责任", "网络侵权", "安全保障义务", "医疗损害", "饲养动物", "环境污染", "生态环境", "生态环境损害赔偿", "名誉权", "荣誉权", "故意伤害"]),
