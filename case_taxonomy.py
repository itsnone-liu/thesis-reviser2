...
AGG = {
    ...
    "合同法":       (55, ["股权转让", "企业借贷", "买卖合同", "借款合同", "确认合同无效", "居间合同", "赠与合同", "租赁合同", "担保", "保证", "定金", "违约金", "电信服务合同", "技术合同", "民间借贷", "债权转让", "房屋买卖", "商品房预售", "所有权确认", "委托贷款", "存款支付", "代位权", "债权纠纷"]),
    "侵权责任":     (50, ["机动车交通事故", "航空旅客运输", "交通运输", "产品责任", "网络侵权", "银行卡纠纷", "网络盗刷", "安全保障义务", "医疗损害", "生命权", "人身权", "健康权", "身体权", "财产损害", "排除妨害", "相邻关系", "相邻通行", "交通事故", "船舶触碰", "饲养动物", "环境污染", "生态环境", "生态环境损害赔偿", "海上污染", "污染损害", "名誉权", "荣誉权", "故意伤害", "人格权", "销售者责任"]),
    "劳动法":       (40, ["劳动合同", "竞业限制", "劳动关系认定", "新就业形态", "工伤", "劳务派遣", "拖欠劳动报酬", "追索劳动报酬", "平等就业权", "就业歧视"]),
    "公司商事":     (40, ["公司法", "公司解散", "公司决议", "股东", "盈余分配", "合伙", "增资", "破产", "保险", "票据", "市场支配地位", "垄断"]),
    "刑法":         (35, ["故意杀人", "盗窃", "诈骗", "抢劫", "贪污", "受贿", "贪污受贿", "挪用公款", "滥用职权", "危险驾驶", "拒不支付劳动报酬", "非法经营", "破坏计算机信息系统", "刑事案件", "刑事"]),
    "婚姻家事":     (30, ["离婚", "抚养", "监护权", "探望权", "继承", "赡养", "收养", "夫妻共同财产", "监护人资格"]),
    "消保与网络":   (30, ["业主共有权", "专项维修资金", "消费者权益", "食品安全", "欺诈", "个人信息", "网络购物", "数据权益"]),
    "知识产权":     (25, ["专利", "商标", "著作权", "集成电路布图设计", "技术秘密", "不正当竞争", "植物新品种", "职务发明"]),
    "民事诉讼法":   (25, ["管辖", "证据", "民事诉讼", "虚假诉讼", "执行", "再审", "诉讼保全", "财产保全", "保全损害", "公益诉讼", "反垄断诉讼程序", "颁发证书", "高等学校", "第三人撤销"]),
    "行政法":       (25, ["行政处罚", "行政许可", "行政征收", "政府信息公开", "行政复议", "国家赔偿", "行政赔偿", "行政诉讼", "公安行政登记", "土地使用权", "强制拆除", "行政处理", "住房公积金", "行政行为", "行政强制"]),
    "建设工程":     (25, ["施工合同", "工程款", "招标投标", "别除权", "优先受偿权", "人防", "房地产开发", "商品房"]),
    "涉外与其他":   (20, ["涉外", "国际商事", "仲裁", "海难救助", "海事", "海上保险", "船舶碰撞", "海上货物运输", "外国法院民事判决", "信用证", "其他"]),
}
TARGET_TOTAL = 400
