...
AGG = {
    ...
    "侵权责任":     (50, ["机动车交通事故", "船舶碰撞", "航空旅客运输", "交通运输", "产品责任", "网络侵权", "银行卡纠纷", "网络盗刷", "安全保障义务", "医疗损害", "生命权", "人身权", "健康权", "身体权", "财产损害", "排除妨害", "相邻关系", "相邻通行", "交通事故", "船舶触碰", "饲养动物", "环境污染", "生态环境", "生态环境损害赔偿", "名誉权", "荣誉权", "故意伤害", "人格权", "销售者责任"]),
