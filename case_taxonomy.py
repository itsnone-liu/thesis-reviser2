...
AGG = {
    ...
    "合同法":       (55, ["买卖合同", "借款合同", "确认合同无效", "居间合同", "赠与合同", "租赁合同", "担保", "保证", "定金", "违约金"]),
    "侵权责任":     (50, ["机动车交通事故", "船舶碰撞", "航空旅客运输", "交通运输", "产品责任", "网络侵权", "安全保障义务", "医疗损害", "饲养动物", "环境污染", "名誉权", "荣誉权", "故意伤害"]),
    "劳动法":       (40, ["劳动合同", "竞业限制", "劳动关系认定", "新就业形态", "工伤", "劳务派遣", "拖欠劳动报酬", "平等就业权", "就业歧视"]),
    ...
    "婚姻家事":     (30, ["离婚", "抚养", "继承", "赡养", "收养", "夫妻共同财产"]),
    "消保与网络":   (30, ["消费者权益", "食品安全", "欺诈", "个人信息", "网络购物", "数据权益"]),
    "知识产权":     (25, ["专利", "商标", "著作权", "不正当竞争", "植物新品种"]),
    "民事诉讼法":   (25, ["管辖", "证据", "执行", "再审", "诉讼保全", "公益诉讼", "反垄断诉讼程序", "颁发证书", "高等学校"]),
    "行政法":       (25, ["行政处罚", "行政许可", "行政征收", "政府信息公开", "行政复议", "国家赔偿", "行政诉讼", "公安行政登记", "土地使用权"]),
    "建设工程":     (25, ["施工合同", "工程款", "招标投标", "人防", "房地产开发"]),
    "涉外与其他":   (20, ["涉外", "国际商事", "仲裁", "其他"]),
}
TARGET_TOTAL = 400
